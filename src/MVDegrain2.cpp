    ...
    if (d->isse)
    {
        switch (nBlkSizeX)
        {
            ...
            case 16:
                ...
                break;
            case 4:
                d->OVERS[0] = mvtools_Overlaps4x4_sse2;    d->DEGRAIN[0] = Degrain2_mmx<4,4>;
            ...
            default:
                if (nBlkSizeY==8) {           d->OVERS[0] = mvtools_Overlaps8x8_sse2;    d->DEGRAIN[0] = Degrain2_sse2<8,8>;
                    if (yRatioUV==2) {            d->OVERS[1] = mvtools_Overlaps4x4_sse2;  d->DEGRAIN[1] = Degrain2_mmx<4,4>;         }
                    else {                        d->OVERS[1] = mvtools_Overlaps4x8_sse2;  d->DEGRAIN[1] = Degrain2_mmx<4,8>;         }
                }else if (nBlkSizeY==4) {     d->OVERS[0] = mvtools_Overlaps8x4_sse2;    d->DEGRAIN[0] = Degrain2_sse2<8,4>;
                    if (yRatioUV==2) {            d->OVERS[1] = mvtools_Overlaps4x2_sse2;    d->DEGRAIN[1] = Degrain2_mmx<4,2>;         }
                    else {                        d->OVERS[1] = mvtools_Overlaps4x4_sse2;  d->DEGRAIN[1] = Degrain2_mmx<4,4>;         }
                }
        }
    }
    else
