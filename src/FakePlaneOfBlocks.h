...
public:
    ...
    inline int GetReducedWidth() const {
        return nBlkX;
    }
    inline int GetReducedHeight() const {
        return nBlkY;
    }
    ...
    inline int GetScaleLevel() const {
        return nLogScale;
    }
    inline int GetEffectiveScale() const {
        return nScale;
    }
    inline int GetBlockSizeX() const {
        return nBlkSizeX;
    }
    inline int GetBlockSizeY() const {
        return nBlkSizeY;
    }
    inline int GetPel() const {
        return nPel;
    }
    inline const FakeBlockData &GetBlock(int i) const {
        return (blocks[i]);
    }
